        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
          ...
          <Section title="Your Account">
            <ul className="list-disc pl-6 space-y-1 text-gray-700 dark:text-gray-300">
              ...
              <li>Notify us promptly at <a href="mailto:hi@chorestar.app" className="text-indigo-600 hover:underline">hi@chorestar.app</a> if you suspect unauthorized use of your account.</li>
            </ul>
          </Section>
