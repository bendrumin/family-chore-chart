...
import { exportFamilyReportCSV, exportFamilyReportPDF } from '@/lib/utils/export'
      ...
      <div className="text-center py-8">
        ...
        <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto">
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-purple-300 transition-all duration-200">
            ...
            <h4 className="font-bold mb-2 text-gray-900 dark:text-gray-100">PNG Charts</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">High-quality printable chore charts (Coming Soon)</p>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-purple-300 transition-all duration-200">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Pre-designed weekly and monthly charts (Coming Soon)</p>
          </div>
        </div>
