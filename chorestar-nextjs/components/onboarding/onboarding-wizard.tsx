...
import { ChevronRight, ChevronLeft, CheckCircle, Users, ListChecks, Star, Trophy, Coins, BarChart3, Flame } from 'lucide-react'
...
const STEPS = [
      ...
      <div className="space-y-4 text-center">
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          <div className="p-4 bg-blue-50 dark:bg-blue-900/30 rounded-xl">
            <Star className="w-6 h-6 mx-auto mb-2 text-blue-600 dark:text-blue-400" />
            <div className="text-sm font-bold text-gray-900 dark:text-gray-100">Track Progress</div>
          </div>
          <div className="p-4 bg-green-50 dark:bg-green-900/30 rounded-xl">
            <Coins className="w-6 h-6 mx-auto mb-2 text-green-600 dark:text-green-400" />
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div className="bg-purple-50/50 dark:bg-purple-900/20 p-6 rounded-xl border-2 border-purple-200 dark:border-purple-700">
        ...
        <div className="bg-blue-50/50 dark:bg-blue-900/20 p-6 rounded-xl border-2 border-blue-200 dark:border-blue-700">
          <h4 className="font-bold mb-2 text-gray-900 dark:text-gray-100">
            2. Choose a fun avatar
          </h4>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Pick from robots, adventurers, or emojis with custom colors
          </p>
        </div>
        <div className="bg-green-50/50 dark:bg-green-900/20 p-6 rounded-xl border-2 border-green-200 dark:border-green-700">
          <h4 className="font-bold mb-2 text-gray-900 dark:text-gray-100">
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <div className="bg-orange-50/50 dark:bg-orange-900/20 p-6 rounded-xl border-2 border-orange-200 dark:border-orange-700">
        ...
        <div className="bg-pink-50/50 dark:bg-pink-900/20 p-6 rounded-xl border-2 border-pink-200 dark:border-pink-700">
        ...
        <div className="bg-indigo-50/50 dark:bg-indigo-900/20 p-6 rounded-xl border-2 border-indigo-200 dark:border-indigo-700">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="p-4 bg-blue-50 dark:bg-blue-900/30 rounded-xl border border-blue-200 dark:border-blue-700">
            <BarChart3 className="w-5 h-5 mb-2 text-blue-600 dark:text-blue-400" />
          ...
          <div className="p-4 bg-green-50 dark:bg-green-900/30 rounded-xl border border-green-200 dark:border-green-700">
            <Flame className="w-5 h-5 mb-2 text-green-600 dark:text-green-400" />
          ...
          <div className="p-4 bg-purple-50 dark:bg-purple-900/30 rounded-xl border border-purple-200 dark:border-purple-700">
            <Trophy className="w-5 h-5 mb-2 text-purple-600 dark:text-purple-400" />
          ...
          <div className="p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-xl border border-yellow-200 dark:border-yellow-700">
            <Coins className="w-5 h-5 mb-2 text-yellow-600 dark:text-yellow-400" />
