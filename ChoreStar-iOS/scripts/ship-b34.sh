#!/bin/bash
# ChoreStar 2.2.2 (build 34): archive -> upload -> notes in four languages ->
...
#
# 2.2.2 = the getting-started checklist on the parent dashboard: three steps
# derived from live data, aimed at the measured funnel leak (kid added, then
# no chores). Mirrors the web card shipped 2026-09-16.
#
