#!/bin/bash
# ChoreStar 2.1.2 (build 30): archive -> re-stamp -> upload -> notes in four
...
#
# 2.1.2 = week-view hotfix: the grid fits the screen (all seven days, no
# sideways scrolling, matching the web), template routine names and steps
# localize into es/pt-BR/ar, header clutter trimmed, per-chore families no
# longer see the daily-bonus caption, plus two warning fixes.
#
