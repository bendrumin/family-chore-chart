#!/bin/bash
# ChoreStar 2.0.1 (build 27): archive -> re-stamp -> upload -> attach -> submit.
#
...
#
# Build 26 on ASC is a stray twin of build 25 (uploaded 2026-08-30, attached
# to nothing, predates the rating flywheel) — skip it, this train is 27.
#
...
echo "==> [5/6] Attaching build ${BUILD} to version ${VERSION} (+ What's New)"
...
echo ""
echo "DONE. ${VERSION} (build ${BUILD}) is WAITING_FOR_REVIEW."
