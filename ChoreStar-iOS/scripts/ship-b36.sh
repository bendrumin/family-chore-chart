#!/bin/bash
# ChoreStar 2.3 (build 36): archive -> upload -> notes in four languages ->
...
#
# 2.3 = chores on the Home Screen and the chart on paper: tappable chore rows
# on the medium and large widgets (a parent tick lands approved, and approves
# a kid's waiting tick), a Large widget showing every kid's list, Export &
# Print in Settings (fridge chart and weekly templates free, family report PDF
# and spreadsheet for premium), Home Screen shortcuts, and a week-start fix so
# ticks land in the same week as the web on Monday- or Saturday-first phones.
#
