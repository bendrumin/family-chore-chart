        ...
        Entry(
            ...
            features: [
                Feature(
                    ...
                    description: "New families see three steps on the dashboard: add a kid, give them chores, let them check one off. It points at the next step, shows your family code for kid login, and disappears once your chart is running."
                ),
            ]
        ),
        Entry(
            version: "2.2.1",
            date: "September 2026",
            title: "Go Back and Check It Off",
            features: [
                Feature(
                    icon: "📅",
                    title: "The Week View Travels",
                    description: "Flip back to any earlier week and mark what actually got done. Especially handy on Sundays, when yesterday already belongs to last week. Backfills count toward earnings and streaks quietly."
                ),
            ]
        ),
        Entry(
            ...
            features: [
                Feature(
                    ...
                    description: "Home opens with your family name and each kid's own progress ring around their avatar. Tap a kid to jump straight to their chores. Seasonal themes paint it exactly like before."
                ),
                Feature(
                    icon: "🎨",
